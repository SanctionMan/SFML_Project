...
{
	m_spriteSize = l_size;
	m_sprite.setOrigin(float(m_spriteSize.x / 2), float(m_spriteSize.y));
}
...
AnimationBase* SpriteSheet::GetCurrentAnim() { return m_animationCurrent; }

bool SpriteSheet::SetAnimation(const std::string& l_name, const bool& l_play /*= false*/, const bool& l_loop /*= false*/)
{
